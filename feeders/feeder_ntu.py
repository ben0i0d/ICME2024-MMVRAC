...
class Feeder_aug(Dataset):
    def __init__(self, data_path, label_path=None, p_interval=1, split='train', random_choose=False, random_shift=False,
                 random_move=False, random_rot=False, window_size=-1, shear_amplitude=0.5, temperal_padding_ratio=8,normalization=False, debug=False, use_mmap=False,
                 bone=False, vel=False):
        """
        :param data_path:
        :param label_path:
    ...
    def __getitem__(self, index):
        ...
        return [data_numpy,data1], label, index
       ...
       # if self.temperal_padding_ratio > 0:
        ...
        if self.shear_amplitude > 0:
            ...
            if flip_prob < 0.5:
                 ...
                 data_numpy = tools.joint_courruption(data_numpy)
